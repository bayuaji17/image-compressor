  ...
  return (
    <div className="app-shell">
      ...
      <main className="mx-auto flex max-w-7xl flex-col gap-10 px-6 pb-16 pt-8 sm:px-10 lg:px-12">
        <PageIntro
          eyebrow="Converter"
          title="Switch formats without losing control."
          description="Convert image formats locally and keep transparent control over output type, quality, and download handling."
        />
        ...
        <ImageGrid
          ...
          emptyLabel="No images yet. Add files above to start converting."
        />
      </main>
    </div>
  );
